    ...
    return (
        <div className='ticket-cards'>
            ...
            <Modal show={show} onHide={handleModalShow}>
                ...
                <Modal.Body>
                    <p><b>Created Date:</b> {moment(props.ticket.dateCreated).format('MMMM D, YYYY h:mm:ss A')}</p>  {/* Shows when the ticket was created */}
                    {props.ticket.status === 'OPEN' || props.ticket.status === 'PENDING' ? null : <p><b>Resolved Date:</b> {moment(props.dateResolved).format('MMMM D, YYYY h:mm:ss A')}</p>} {/* Shows when the ticket was resolved, if applicable */}
