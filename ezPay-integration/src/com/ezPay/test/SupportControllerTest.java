...
public class SupportControllerTest {
    ...
    public void testCreateTicket() {
        ...
        supportService.createTicket(1, "Issue with account settings.");
    ...
    public void testViewTickets() {
        supportService.createTicket(1, "Issue with payment gateway.");
        supportService.createTicket(1, "Unable to update profile.");
    ...
    public void testResolveTicket() {
        supportService.createTicket(1, "Issue with app crashing.");
